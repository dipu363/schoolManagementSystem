        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- panel body end -->
                    <!-- DataTables Example -->
                    <div class="card mb-3" ng-app="mystudent" ng-controller="studentController">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="student in studentlists">
                                         <td><img class="img-responsive" style="width:75px ;height:90px" src="resources/stimage/{{student.stid}}.jpg" />    </td>
                                            ...
                                            <td><a href="editingstudent?getsid={{student.stid}}"><button id="editbuttons" type="submit" class="btn">Edit</button></a> <a href="removingstudent/{{student.stid}}"><button id="removebuttons" type="button" class="btn btn-danger ">Remove</button></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
