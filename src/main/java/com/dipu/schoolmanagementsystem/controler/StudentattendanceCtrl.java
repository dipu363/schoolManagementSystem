...
import com.dipu.schoolmanagementsystem.dao.StudentattendanceService;
...
import com.dipu.schoolmanagementsystem.model.Studentattendance;
...
//        binder.registerCustomEditor(String.class, "ename", new EmployeeNameEditor());
    ...
    public ModelAndView showteacherpage() {
        ...
        ModelAndView mv = new ModelAndView("attendence", "attendenceObject", new Studentattendance() );
    ...
    public ModelAndView editoneattendenc(@RequestParam("getatid") int atnid) {
      String attendencelist=atten.viewattendenc();
        ...
        ModelAndView mv = new ModelAndView("attendence", "attendenceObject", atten.viewOneattendenc(atnid));
