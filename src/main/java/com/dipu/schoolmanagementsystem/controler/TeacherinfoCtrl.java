...
//        binder.registerCustomEditor(String.class, "ename", new EmployeeNameEditor());
    ...
    public ModelAndView showteacherpage() {
        ...
        ModelAndView mv = new ModelAndView("teacherinfo", "newTeacherObject", new Teacherinfo() );
    ...
    @RequestMapping("/showteacherhomepage")
    public ModelAndView showteacherhome() {

        ModelAndView mv = new ModelAndView("teacherhome" );
   
        return mv;
    }
    @RequestMapping("/showteacherliset")
    public ModelAndView showtlist() {
        String teacherlist=teacher.viewTeacher();
        String sublist = sub.viewSubject();
       

        ModelAndView mv = new ModelAndView("teacherlist", "newTeacherObject", new Teacherinfo() );
        mv.addObject("teacherlist", teacherlist);
        mv.addObject("sublist", sublist);
...
//        path = path + String.valueOf(product.getProductid()) + "" + ".jpg";
    ...
    public ModelAndView editoneteacher(@RequestParam("gettid") int tid) {
        ...
        ModelAndView mv = new ModelAndView("teacherinfo", "newTeacherObject", teacher.viewOneTeacher(tid));
        mv.addObject("teacherlist", teacherlist);
        mv.addObject("sublist", sublist);
