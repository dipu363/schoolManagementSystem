<%-- 
    Document   : guardianhome
    Created on : Dec 20, 2018, 12:41:48 AM
    Author     : HP
--%>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="guardianwelcome">Hello ${sessionScope.UserLoggedIn}</a>
        ...
        <div id="wrapper">
            ...
            <ul class="sidebar navbar-nav" style="background:  #0c5460">
                <li class="nav-item active">
                    <a class="nav-link" href="guardianwelcome">
