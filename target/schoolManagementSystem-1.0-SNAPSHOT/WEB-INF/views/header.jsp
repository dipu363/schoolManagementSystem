...
<html>
    ...
    <body>
        ...
        <div class="header-w3-agileits" id="home">
            <div class="inner-header-agile" style="text-align: center">	
              

                <h1><span class="letter">N</span>asir <span class="letter">U</span>ddin <span class="letter">M</span>odel <span class="letter">S</span>chool <span style="color: #e43725">&</span> <span class="letter">C</span>ollege  <a  href="<%=request.getContextPath()%>"><button class="btn btn-primary">Home</button></a></h1>
