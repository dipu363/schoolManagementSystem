        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <br>
                    <!-- DataTables Example -->
                    <div class="card mb-3" ng-app="myapp" ng-controller="userctrl">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <td>{{user.userrole}} </td>
                                    <td>{{user.phone}} </td>
                                    <td>  <a href="removeuser/{{user.emailid}}"><button id="removebuttons" type="button" class="btn btn-danger ">Remove</button></a></td>
