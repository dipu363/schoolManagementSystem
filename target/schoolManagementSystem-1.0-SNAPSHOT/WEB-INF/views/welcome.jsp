            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="adminwelcome">Hello ${sessionScope.UserLoggedIn}</a>
            ...
            <ul class="sidebar navbar-nav" style="background:  #0c5460">
                ...
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu"  style="background:  #02a388"  aria-labelledby="pagesDropdown">
                        ...
                        <div class="dropdown-divider"></div>
                        <h6 class="dropdown-header">Other Manu:</h6>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu"  style="background:  #02a388" aria-labelledby="pagesDropdown">
                        ...
                        <a class="dropdown-item" href="paymentreportpage">Search Payment List</a>
                        ...
                        <a class="dropdown-item" href="shomessage">Show User Message</a>
                        ...
                        <a class="dropdown-item" href="searchattendancsheet"></a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="showpaymentpage">
                        ...
                        <span> Take Monthly Payment</span></a>
                </li>
                <li class="nav-item">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="showwelcomepage">Shortcut</a>
                        </li>
