                    ...
                    <header id="header">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li><a href="showwelcomepage" ><button style="width: 100px; height: 50px; background: darkturquoise; font-size: medium">Home</button> </a></li>
                                <li><a href="adminwelcome" > <button style="width: 100px; height: 50px; background: darkturquoise; font-size: medium">Profile</button> </a></li>
                                <li><a href="adminsignuppage" > <button style="width: 100px; height: 50px; background: darkturquoise; font-size: medium">Admin</button> </a></li>
