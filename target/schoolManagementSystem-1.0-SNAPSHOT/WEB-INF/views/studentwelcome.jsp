                    ...
                    <header id="header">
                        ...
                        <nav>
                            <ul>
                               ...
                               <li><a href="showStudenthome" ><button style="width: 100px; height: 50px; background: darkturquoise; font-size: medium">Home</button> </a></li>
                                <li><a href="studentwelcome" > <button style="width: 100px; height: 50px; background: darkturquoise; font-size: medium">Profile</button> </a></li>
